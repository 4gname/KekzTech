...
public class GTMTE_KekzGenT2 extends GT_MetaTileEntity_MultiBlockBase {
    ...
    public GTMTE_KekzGenT2(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);

    }

    public GTMTE_KekzGenT2(String aName) {
        super(aName);
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity var1) {
        return new GTMTE_KekzGenT2(super.mName);
    }
