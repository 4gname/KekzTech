...
public class GTMTE_KekzGenT3 extends GT_MetaTileEntity_MultiBlockBase {
	
	final Block CASING = GregTech_API.sBlockCasings4;
	final int CASING_META = 0;
	final int CASING_TEXTURE_ID = 48;
	
	private final int OXYGEN_PER_TICK = 200;
	private final int EU_PER_TICK = 26750;
	private final int STEAM_PER_TICK = 3000;

	protected int fuelConsumption = 0;
	
	public GTMTE_KekzGenT3(int aID, String aName, String aNameRegional) {
		super(aID, aName, aNameRegional);
		
	}

	public GTMTE_KekzGenT3(String aName) {
		super(aName);
	...
	public IMetaTileEntity newMetaEntity(IGregTechTileEntity var1) {
		return new GTMTE_KekzGenT3(super.mName);
	}
