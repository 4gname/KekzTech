...
public class GTMTE_KekzGenT1 extends GT_MetaTileEntity_MultiBlockBase {
	...
	public GTMTE_KekzGenT1(int aID, String aName, String aNameRegional) {
		super(aID, aName, aNameRegional);
		
	}

	public GTMTE_KekzGenT1(String aName) {
		super(aName);
	...
	public IMetaTileEntity newMetaEntity(IGregTechTileEntity var1) {
		return new GTMTE_KekzGenT1(super.mName);
	}
