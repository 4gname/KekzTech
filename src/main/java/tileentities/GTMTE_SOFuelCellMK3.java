...
public class GTMTE_SOFuelCellMK3  extends GT_MetaTileEntity_MultiBlockBase {
    ...
    public GTMTE_SOFuelCellMK3(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);

    }

    public GTMTE_SOFuelCellMK3(String aName) {
        super(aName);
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity var1) {
        return new GTMTE_SOFuelCellMK3(super.mName);
    }
    ...
    public String[] getDescription() {
        ...
        b.addInfo("Oxidizes gas fuels to generate electricity without polluting the environment")
                ...
                .addOtherStructurePart("GDC Ceramic Unit", "3x, Center 1x1x3")
                .addOtherStructurePart("Reinforced Glass", "6x, touching the electrolyte units on the horizontal sides")
                .addCasingInfo("Stable Titanium Machine Casing", 12)
    ...
    public String[] getInfoData() {
        ...
        return new String[]{
/* 1 line */	"Solid-Oxide Generator MK II" + EnumChatFormatting.RESET,
