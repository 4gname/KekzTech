...
public class MultiFluidHandler2 {

	public static final int MAX_DISTINCT_FLUIDS = 1;
	...
	public MultiFluidHandler2() {

	}

	public MultiFluidHandler2(int capacityPerFluid) {
		this.capacityPerFluid = capacityPerFluid;
	}

	public MultiFluidHandler2(int capacityPerFluid, List<FluidStack> fluids) {
		this.capacityPerFluid = capacityPerFluid;
	...
	public void loadNBTData(NBTTagCompound nbt) {
		...
		for(int i = 0; i < MultiFluidHandler2.MAX_DISTINCT_FLUIDS; i++) {
